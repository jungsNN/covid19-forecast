...
DATA_DIR = 'myapp/static/resources/forecast/data'
SERVE_DIR = 'myapp/static/resources/forecast/serve'
...
LAST_DATA = pd.read_csv(os.path.join(SERVE_DIR, 'recent_forecast.csv'))
...
def run_app():
    ...
    reopen_data = pd.read_csv(os.path.join(DATA_DIR, nyt_reopen_filename))
